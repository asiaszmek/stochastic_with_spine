...
if __name__ == '__main__':
    for dur in stim_dict.keys():
        ...
        for i, fname in enumerate([file_dend_ER_ctrl, file_dend_ER_ctrl_IP3, file_spine_ER_dend_ER, file_spine_ER_dend_ER_IP3]):
            auc_head_m = []
            auc_neck_m = []
            auc_dend_m = []
            max_head_m = []
        ...
        fig.savefig("Just_spine_head_stim_IP3_dend_max_vs_head_max_%s_ms.png" % dur, dpi=100, bbox_inches="tight")
        fig2.savefig("Just_spine_head_stim_IP3_neck_auc_vs_head_auc_%s_ms.png" % dur, dpi=100, bbox_inches="tight")
        fig1.savefig("Just_spine_head_stim_IP3_dend_auc_vs_head_auc_%s_ms.png" % dur, dpi=100, bbox_inches="tight")
        fig_n.savefig("Just_spine_head_stim_IP3_dend_auc_vs_neck_auc_%s_ms.png" % dur, dpi=100, bbox_inches="tight")
        fig1_n.savefig("Just_spine_head_stim_IP3_dend_max_vs_neck_max_%s_ms.png" % dur, dpi=100, bbox_inches="tight")

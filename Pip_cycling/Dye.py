...
def Parser():
    ...
    parser.add_argument('input', nargs='+',
                        help='input files')
    parser.add_argument('--t_init', default=180000, type=float,
                        help='Stimulation initiation in ms')
    parser.add_argument('--specie', default='DyeCa',
                        help='sensor')
...
if __name__ == "__main__":
    ...
    for fname in fnames:
        ...
        for key in my_file.keys():
            ...
            tubby = get_concentrations_region_list(my_file,["dend01"],
                                                   trial=key,
                                                   out=output,
                                                   specie=args.specie)
            data.append(tubby)

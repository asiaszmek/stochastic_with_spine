...
files_no_ER_ctrl = os.path.join("..", "1_spine_1_EPSP",
                           "model_RyR2CaM_%s_um_dend_spine_old_age_1_EPSP.h5")
files_ER_ctrl = os.path.join("..", "1_spine_1_EPSP",
                             "model_RyR2CaM_RyR3CaM_%s_um_dend_spine_old_age_1_EPSP.h5")
files_ER_big_spine = os.path.join("..", "1_spine_1_EPSP",
                                  "model_RyR2CaM_%s_um_dend_spine_1_EPSP.h5")
dend_diam = ["1.2", "2.4", "6.0"]
types = ["Old age no spine  ER", "Old age spine ER", "ctrl no spine ER"]
markers = ["^", "o", "s"]
...
if __name__ == '__main__':
    ...
    plt.show()
    fig.savefig("Max_Ca_conc_1_EPSP_old_age.png", dpi=100, bbox_inches="tight")

...
types = ["no RyR3CaM in vitro", "RyR3CaM in neck in vitro", "big spine RyR3CaM in neck in vitro", "big spine RyR3 in head and neck in vitro",]
markers = ["^", "o", "s"]
...
if __name__ == '__main__':
    ...
    fig.savefig("TBS_distance_ctrl_in_vitro.png", dpi=100, bbox_inches="tight")

...
files = [os.path.join("..", "TBS",
         ...
         os.path.join("..", "TBS",
                      "model_RyR2CaM_RyR3CaM_%s_um_dend_big_spine_IC_TBS_in_vivo.h5")]

dend_diam = ["1.2", "2.4", "6.0"]
types = ["no RyR3CaM in vivo", "RyR3CaM in neck in vivo", "big spine RyR3CaM in neck in vivo", "big spine RyR3 in head and neck in vivo",]
markers = ["^", "o", "s"]
...
if __name__ == '__main__':
    ...
    fig.savefig("TBS_distance_ctrl_in_vivo.png", dpi=100, bbox_inches="tight")

...
files_no_ER_ctrl = os.path.join("..", "TBS",
                           "model_RyR2CaM_%s_um_dend_spine_TBS.h5")
files_ER_ctrl = os.path.join("..", "TBS",
                             "model_RyR2CaM_RyR3CaM_%s_um_dend_spine_TBS.h5")
files_ER_big_spine = os.path.join("..", "TBS",
                                  "model_RyR2CaM_RyR3CaM_%s_um_dend_big_spine_TBS.h5")
files_ER_big_spine_IC = os.path.join("..", "TBS",
                                  "model_RyR2CaM_RyR3CaM_%s_um_dend_big_spine_IC_TBS.h5")
...
if __name__ == '__main__':
    ...
    plt.show()
    fig.savefig("Max_Ca_conc_TBS_ctrl.png", dpi=100, bbox_inches="tight")

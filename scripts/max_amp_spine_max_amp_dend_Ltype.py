...
if __name__ == '__main__':
    for dur in stim_dict.keys():
        ...
        for i, fname in enumerate([file_dend_ER_ctrl,file_dend_ER_dend_Ca, file_spine_ER_dend_ER,
            ...
            for inj in stim_dict[dur]:
                ...
                dend_ca, time_dict = utils.get_conc(my_data, "Ca", ["dend11"],
                                                    output)
                head_ca, time_head_dict = utils.get_conc(my_data, "Ca",
                                                         ['head'],
                                                         output)
                neck_ca, time_head_dict = utils.get_conc(my_data, "Ca",
                                                         ['neck'], output)
        ...
        fig.savefig("Head_dend_Ca_stim_dend_max_vs_head_max_%s_ms.png" % dur, dpi=100, bbox_inches="tight")
        fig2.savefig("Head_dend_Ca_stim_neck_auc_vs_head_auc_%s_ms.png" % dur, dpi=100, bbox_inches="tight")
        fig1.savefig("Head_dend_Ca_stim_dend_auc_vs_head_auc_%s_ms.png" % dur, dpi=100, bbox_inches="tight")
        fig_n.savefig("Head_dend_Ca_stim_dend_auc_vs_neck_auc_%s_ms.png" % dur, dpi=100, bbox_inches="tight")
        fig1_n.savefig("Head_dend_Ca_stim_dend_max_vs_neck_max_%s_ms.png" % dur, dpi=100, bbox_inches="tight")
